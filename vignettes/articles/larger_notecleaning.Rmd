...
In the first row, the FNC method is able to correctly distinguish between old and new notes (with a slight issue due to a deleted line break between sentences, resulting in the lose of "Po" at the beginning of "Police").
