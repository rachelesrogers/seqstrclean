...
#'
#'This uses the longest common substring method of note cleaning, where the
#'longest common substring between the two note pages is identified and removed
#'if it is longer than a set threshold.
#'
